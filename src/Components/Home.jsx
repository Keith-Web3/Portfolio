...
`,
  ...
  const handleDownload = () => {
    saveAs('google drive url', 'Resume.pdf')
  }
      ...
      <div className="home-text">
        <h1>
          <span className="gradientText">
            Hi, I'm Olorunnishola Olamilekan!
          </span>
          <span>
        ...
        <TypeWriterEffect
          cursorColor="#1da1f2"
          multiText={['Web Developer', "Don't Forget to Scroll"]}
          multiTextLoop={true}
          multiTextDelay={1500}
          typeSpeed={35}
        />
        <div className="btns">
          ...
          <div onClick={handleDownload} className="btn2">
            View Resume
          </div>
        </div>
      </div>
